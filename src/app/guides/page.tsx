...
const upcomingGuides = [
  {
    tag: "Industry",
    title: "AI for Accountants: Tax Prep, Client Reports & Audit-Ready Documentation in 20 Minutes a Day",
    desc: "Use free AI to automate tax prep, client reports, engagement letters, and audit documentation. 5 copy-paste prompts for solo and small firm accountants. No paid tools required.",
    href: "/guides/ai-for-accountants",
    status: "live",
  },
  {
    tag: "Operations",
    title: "AI for Hiring: How Small Businesses Can Recruit Faster & Smarter",
    desc: "Use free AI to write job posts, screen resumes, and interview candidates. 5 copy-paste prompts. No HR experience needed.",
    href: "/guides/ai-for-hiring",
    status: "live",
  },
  {
    tag: "Operations",
  ...
  },
  {
    ...
    desc: "Copy-paste AI prompts for client reports, winning proposals, and SOPs your team actually follows. Free workflow for marketing agencies. No tools required.",
    href: "/guides/ai-for-agencies",
    status: "live",
  },
  {
    tag: "Industry",
  ...
  {
    tag: "Industry",
    title: "AI for Law Firms: Client Intake, Document Drafting & Case Research",
    desc: "Use free AI to automate legal intake, draft documents, and research cases. 5 copy-paste prompts for solo and small firm lawyers. No legal tech required.",
    href: "/guides/ai-for-law-firms",
    status: "live",
  },
  {
    tag: "Industry",
  ...
  },
  {
    ...
    href: "/guides/claude-vs-gemini-business",
    status: "live",
  },
  {
    tag: "Marketing",
    title: "The Complete Guide to AI Prompts for Marketing: Build a Reusable Library in 60 Minutes",
    desc: "Stop collecting prompt lists. Build a reusable AI marketing prompt library in 60 minutes. 5 copy-paste prompts, a weekly workflow, and a tracking system. Free guide.",
    href: "/guides/ai-prompts-for-marketing",
    status: "live",
  },
  {
    tag: "Strategy",
    title: "AI Financial Forecasting for Small Business: What You Can Trust",
    desc: "Use AI for financial forecasting without expensive tools. Free ChatGPT + Excel workflows, 5 copy-paste prompts, and a trust framework that keeps you safe.",
    href: "/guides/ai-financial-forecasting",
    status: "live",
  },
  {
    tag: "Strategy",
