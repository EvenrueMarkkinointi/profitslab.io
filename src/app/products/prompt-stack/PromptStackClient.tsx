...
export default function PromptStackClient() {
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "AI Shortcut Stack", item: "https://www.profitslab.io/products/prompt-stack/" },
            ],
          }),
        }}
      />
      ...
      <nav className="breadcrumb" aria-label="Breadcrumb">
        <div className="breadcrumb-inner">
          ...
          <span aria-hidden="true">›</span>
          <span aria-current="page">AI Shortcut Stack</span>
        </div>
      </nav>
